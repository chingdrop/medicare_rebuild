...
class TestDatabaseManager:
    ...
    def test_create_engine(self, mock_create_engine, db_manager):
    ...
    def test_execute_query(self, mock_execute, db_manager):
        db_manager.session = sessionmaker()
    ...
    def test_read_sql(self, mock_read_sql, db_manager):
        mock_df = MagicMock()
    ...
    def test_to_sql(self, mock_to_sql, db_manager):
        mock_df = MagicMock()
        db_manager.engine = create_engine(URL.create("sqlite:///:memory:"))
    ...
    def test_close(self, mock_dispose, db_manager):
        mock_engine = MagicMock()
